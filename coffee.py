class CoffeeMachine:
    ...
    def buy(self):
        ...
        if choice == "1":
            ...
            if self.machine_water <= self.cappuccino_water:
                print("Sorry, not enough water!")
    ...
    def fill(self):
        ...
        self.machine_coffee = self.machine_coffee + int(input("Write how many grams of coffee beans do you want to add:"))
        self.machine_cups = self.machine_cups + int(input("Write how many disposable cups of coffee do you want to add:"))
...
{} of coffee beans
{} of disposable cups
${} of money'''.format(self.machine_water, self.machine_milk, self.machine_coffee, self.machine_cups, self.machine_money))
